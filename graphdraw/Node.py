...
class Node:
	...
	def remove_edge_start(self, neighbor, side, overlap):
		"""
	...
	def remove_edge_end(self, neighbor, side, overlap):
		"""
	...
	def add_edge_start(self, other, direction, overlap=0):
		if direction == 0:
			self.start.append((other.id, 0, overlap))
			other.start.append((self.id, 0, overlap))
		elif direction == 1:
			self.start.append((other.id, 1, overlap))
			other.end.append((self.id, 0, overlap))

	def add_edge_end(self, other, direction, overlap=0):
		if direction == 0:
			self.end.append((other.id, 0, overlap))
			other.start.append((self.id, 1, overlap))
		elif direction == 1:
			self.end.append((other.id, 1, overlap))
			other.end.append((self.id, 1, overlap))